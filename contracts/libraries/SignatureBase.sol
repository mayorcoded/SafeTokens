...
library SignatureBase {
    /**
    * @dev generate a has from encoded withdraw parameters
    * @param _to The recipient of the tokens
    * @param _amount Amount of tokens to send to the beneficiary
    * @param _nonce A number that increases the randomness of the hash
    */
    ...
    * @param _messageHash bytes32 message hash
    */
    ...
    /// @param sig concatenated rsv signatures
